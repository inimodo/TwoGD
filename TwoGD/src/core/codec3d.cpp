...
uint8_t
codec3d::DrawObject(OBJ3D * o_Object, COLOR * c_pColor, uint8_t i_PixelFlag,uint8_t i_PrioFlag)
{
...
uint8_t
codec3d::DrawEdge(V3 * v_pVertexA, V3 * v_pVertexB, COLOR * c_pColor, uint8_t i_PixelFlag, uint8_t i_PrioFlag)
{
	V2 v_PointA, v_PointB;
